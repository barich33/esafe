...
const SoilType = () => {  
  ...
  const showSuccess = () => {
    ...
    notification.success({
      message: `${isEditMode ? "Update" : "Add"} Soil Type`,
      description: `Soil Type ${isEditMode ? "Updated" : "Added"} Successfully.`,
    });
  };
  ...
  const showError = (message = null) => {
    ...
    notification.error({
      ...
      description: message
        ? message
        : `unable to ${isEditMode ? "update" : "add"} Soil Type`,
    });
  };
