...
const Insect = () => {  
  ...
  const showSuccess = () => {
    ...
    notification.success({
      message: `${isEditMode ? "Update" : "Add"} Insect`,
      description: `Insect ${isEditMode ? "Updated" : "Added"} Successfully.`,
    });
  };
  ...
  const showError = (message = null) => {
    ...
    notification.error({
      ...
      description: message
        ? message
        : `unable to ${isEditMode ? "update" : "add"} Insect`,
    });
  };
